    ...
    const scheduleNextSpawn = () => {
      ...
      const timeoutId = window.setTimeout(() => {
        setMonsters((prev) => {
          ...
          console.log(`Stare spawn: fear=${fear}, night=${currentNight}, fearMult=${spawnMultiplier.toFixed(2)}, nightMult=${nightMultiplier.toFixed(2)}, finalChance=${(adjustedChance * 100).toFixed(1)}%`);
